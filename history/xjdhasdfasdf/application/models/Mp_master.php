...
class MP_Master extends CI_Model
{
    ...
    function Show($mainPlaceHolder, $headerPlaceHolder, $pageTitle, $data)
    {
        ...
        $data['headerPlaceHolder'] = '
<link href="/public/account/style/user.css" rel="stylesheet" type="text/css" />
                <script src="/public/admin/js/jquery-1.8.2.min.js" type="text/javascript"></script>
                <script src="/public/account/js/account.js" type="text/javascript"></script>' .
            $headerPlaceHolder;
