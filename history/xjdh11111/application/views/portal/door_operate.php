<div class="main-wrapper">
	<div class="container-fluid">
		...
		<div class="row-fluid">
    		<div class='span12'>
    		  <h4><?php echo htmlentities($devObj->substation_name, ENT_COMPAT, "UTF-8"); ?>&nbsp&nbsp<?php echo htmlentities($devObj->room_name, ENT_COMPAT, "UTF-8"); ?>&nbsp&nbsp<?php echo htmlentities($devObj->name, ENT_COMPAT, "UTF-8"); ?></h4>
    		</div>
    	</div>
		<div class="row-fluid">
			<div class='span12'>
