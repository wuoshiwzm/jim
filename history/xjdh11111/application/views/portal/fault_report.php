					...
					<div class="widget-container">
						...
						<?php if($ecType == '1'){?>
							...
							<tr>
								...
								<td><?php echo $i++;?></td>
								<td><?php echo htmlentities($alarmRankObj->subname,ENT_COMPAT,"UTF-8");?>-><?php echo htmlentities($alarmRankObj->roomname,ENT_COMPAT,"UTF-8");?>-><?php echo htmlentities($alarmRankObj->devname,ENT_COMPAT,"UTF-8");?></td>
