		...
		<tbody>
			...
			<tr>
				...
				<td class="hasThreshold"
					...
					<button style="display: none;"
						data_id='<?php echo $dataObj->data_id;?>'
						field="wind_temperature" class="btn btn-warning setThreshold">设置阈值</button></td>
			</tr>
			<tr>
				<td>12</td>
				<td>出风湿度</td>
				<td class="hasThreshold"
					...
					<button style="display: none;"
						data_id='<?php echo $dataObj->data_id;?>'
						field="wind_humidity" class="btn btn-warning setThreshold">设置阈值</button></td>
			</tr>
			<tr>
				<td>13</td>
				<td>室外温度</td>
			...
			<tr>
				...
				<td class="hasThreshold"
					...
					<button style="display: none;"
						data_id='<?php echo $dataObj->data_id;?>'
						field="humidifier_current" class="btn btn-warning setThreshold">设置阈值</button></td>
			</tr>
			<tr>
				<td>16</td>
				<td>平均温度</td>
			...
			<tr>
				...
				<td class="hasThreshold"
					...
					<button style="display: none;"
						data_id='<?php echo $dataObj->data_id;?>'
						field="highest_temperature" class="btn btn-warning setThreshold">设置阈值</button></td>
			</tr>
			<tr>
				<td>21</td>
				<td>湿帘加湿水泵</td>
