...
<!-- 								</div> -->
								<div class="controls" style="margin-left: 20px; float: left;">	
								<select class="chzn-select" data-placeholder="选择信号名称 "
									name='txtSignalName' id='txtSignalName' >
									<option value=''>所有信号名称</option>
								   <?php foreach (Defines::$gSendAlarmSignalName as $key=>$val){?>
								   <option
...
<!-- 								</div> -->
								<div class="controls" style="margin-left: 20px; float: left;">
								<select class="chzn-select" data-placeholder="选择告警描述 "
										name='txtSubject' id='txtSubject' >
										<option value=''>所有告警描述</option>
									   <?php foreach (Defines::$gSendAlarmDescribe as $key=>$val){?>
									   <option
										<?php if($baud_rate == $val) {?>
											selected="selected" <?php }?> value='<?php echo $val;?>'><?php echo $val;?></option>
									   <?php }?>
