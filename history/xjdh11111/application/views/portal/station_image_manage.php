				...
				<div class="content-widgets light-gray">
					...
					<div class="widget-head bondi-blue">
                      ...
                      <ul class="dowebok">
                                ...
                                <li class="dowebok1">                                 
                                 <a class="deleteImg" val="<?php echo $substationObjs->id?>" href="#">删除</a>/<a href="/portal/updat_Stationimage/<?php echo $substationObjs->id?>">修改</a>/
                                 <?php if(substr(strrchr($substationObjs->stationImage, '.'), 0)==".flv"){?>
								 <a rel="group" class="video" href="#<?php echo $substationObjs->stationImage?>" title="<?php echo $substationObjs->updataTime?>">video link</a>
								 <?php }else{?>				
								 <a rel="group"  class="image" href="/public/portal/Station_image/<?php echo $substationObjs->stationImage?>" title="<?php echo $substationObjs->updataTime?>">文本
								 <img class="example1" src="/portal/station_thumb/<?php echo $substationObjs->stationImage?>" />								
								 </a>
								 <?php }?>
							...
							<?php $i = $offset + 1;foreach ($substationList as $substationObj){?>  
							 <tr>
									...
									<ul class="dowebokList">
										...
										<li class="dowebok1">	
										<?php if(substr(strrchr($imgObj["img"], '.'), 0)==".flv")	{?>
										<?php $videoObj = $imgObj["img"]?>
										<a rel="group" class="video" href="#<?php echo $videoObj ?>" title="<?php echo $imgObj["updataTime"]?>">Vedio Link</a>
										<?php }else{?>				
										<a rel="group" class="image" href="/public/portal/Station_image/<?php echo $imgObj["img"]?>" title="<?php echo $imgObj["updataTime"]?>">								
										<img src="/portal/station_thumb/<?php echo $imgObj["img"]?>" alt="" /></a>
										<?php }?>
										</li>
										<?php }?>
									</ul>
									...
									<td><a class="btn btn-info" href="/portal/station_image_manage?substationid=<?php echo $substationObj['id'];?>">详细信息</a>
