					...
					<div class="widget-container">
                		...
                		<?php }?>
							...
							<div class="control-group">
								...
								<label class="control-label"  id='ups' style="float: left; display: none;">所属分组<span id='must1' style="display: none;"><font size=4 color=red>&nbsp;*</font></span></label>
									<div class="controls" style="margin-left: 20px; float: left;">
										<input type="text"  name='devgroup' id='devgroup1' style="display: none;" <?php if(count($devObj)){?>
										value="<?php echo htmlentities($devObj->dev_group,ENT_COMPAT,"UTF-8");?>" <?php }?>/>
									</div>
									<span class="help-block error" id='text2'   style="display: none;">
															&nbsp;&nbsp;注：多组电池板采集同一组电池时，分组名为蓄电池名。
									</span>	
							</div>
							<div class="control-group">
