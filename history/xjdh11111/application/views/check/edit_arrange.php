<form class="form-horizontal">
    <div class="control-group">
        <label class="control-label" style="float: left;">选择要安排的督导</label>
        <div class="controls" style="margin-left: 20px; float: left;">
            <select class="chzn-select" data-placeholder="选择督导"
                    name='user' id='user'>

                <option value="<?php echo $arrange->user_id?>" selected="selected">
                    <?php echo $this->mp_extra->get_user_fullname($arrange->user_id)?>
                </option>
        ...
        <button class="btn btn-success" id="close" type="submit" style="margin-left: 100px;">确认</button>
    </div>
