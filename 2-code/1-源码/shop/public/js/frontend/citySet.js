    ...
    $("#_citys0 a").click(function () {
        ...
        $("#_citys1 a").click(function () {
            ...
            $("#_citys2 a").click(function () {
                ...
                var bc = $("#hcity").val();
                var bp = $("#hproper").val();
                var city = bc + bp + $(this).data("name");
                $("#city").html(city);
                Iput.colse();
                getFreight($(this).data("id"));
            });
...
{
    $.get('/get/freight',{weight:$("#weight").val(),freight:$("#freight").val(),region:region},function ( msg ) {
        var str = msg.name+'-'+msg.price;
        $("#yundan02").html( str );
    },'json')
}
