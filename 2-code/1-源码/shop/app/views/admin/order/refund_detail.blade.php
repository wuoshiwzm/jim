            ...
            <div class="order-info">
                <div class="order-left">
                    ...
                    <div class="order-goods">
                         <?php  $item =  isset($refund->item->id)?$refund->item->first():null;?>
                        <div class="goodsPicBox pull-left m-r-10">
                            <a href="/{{$item->product_id}}.html" target="_blank">
                                <img src="{{ getImgSize( 'goods', $item!=null?$item->product_id:'', isset($item->product->small_image)?$item->product->small_image:'' ) }}" class="goods-thumb">
                            </a>
                        </div>
                        <div class="ng-binding refund-message">
                            <div class="name">
                                <a href="/{{$item!=null?$item->product_id:''}}.html" target="_blank">{{isset($refund->item->product_name)?$refund->item->product_name:""}}</a>
                            </div>
                    ...
                    <div class="refund-info">
                        <dl>
                            ...
                            <dd>
                                <span>{{isset($refund->user->real_name)?$refund->user->real_name:''}}</span>
                            </dd>
                        </dl>
                        ...
                        <dl>
                            ...
                            <dd>
                                <span>￥{{isset($refund->item->price)?$refund->item->price:''}} * {{$refund->item->num}}（数量）</span>
                            </dd>
                        </dl>
                        <dl>
                            <dt>
                        ...
                        <ul>
                            <li class="operate-steps pic_m_r">
                                ...
                                @foreach( json_decode($refund->image) as $img)
                                     <img style="width: 384px;  height: 250px" src="{{$img}}" class="goods-thumb">
                                @endforeach
                                @endif
                            </li>
                        </ul>
