            ...
            <table id="table_list" class="table">
                @foreach($list as $val)
                    ...
                    <tr class="order-hd order-top">
                        <td colspan="6">
                            <div>
                                <span class="order-num">{{$val->name}}</span>[{{$val->is_freeshipping==1?'免邮费':'自定义运费'}}}]
                    ...
                    @if($val->is_freeshipping ==0)
                        <tr class="order-item table_yun_th">
                            ...
                            @if($val->jifei_model  ==1)
                            <td class="contact" width="14%">首件</td>
                            <td class="contact" width="14%">运费（元）</td>
                            <td class="contact" width="14%">续件</td>
                            <td class="contact" width="14%">运费（元）</td>
                            @elseif($val->jifei_model  ==2)
                            <td class="contact" width="14%">首重（Kg）</td>
                            <td class="contact" width="14%">运费（元）</td>
                            <td class="contact" width="14%">续重（Kg）</td>
                            <td class="contact" width="14%">运费（元）</td>
                            @elseif($val->jifei_model  ==3)
                            <td class="contact" width="14%">首体积</td>
                            <td class="contact" width="14%">运费（元）</td>
                            <td class="contact" width="14%">续体积</td>
                            <td class="contact" width="14%">运费（元）</td>
                            @endif
                        </tr>
                        ...
                        @foreach( $detail  as $dt)
                            <tr class="order-item">
                                ...
                                @if($val->jifei_model  ==1)
                                    <td class="contact">{{$dt->FirstPiece}}</td>
                                    <td class="contact">{{$dt->FirstAmount}}</td>
                                    <td class="contact">{{$dt->SecondPiece}}</td>
                                    <td class="contact">{{$dt->SecondAmount}}</td>
                                @elseif($val->jifei_model  ==2)
                                    <td class="contact">{{$dt->FirstWeight}}</td>
                                    <td class="contact">{{$dt->FirstAmount}}</td>
                                    <td class="contact">{{$dt->SecondWeight}}</td>
                                    <td class="contact">{{$dt->SecondAmount}}</td>
                                @elseif($val->jifei_model  ==3)
                                    <td class="contact">{{$dt->FirstBulk}}</td>
                                    <td class="contact">{{$dt->FirstAmount}}</td>
                                    <td class="contact">{{$dt->SecondBulk}}</td>
                                    <td class="contact">{{$dt->SecondAmount}}</td>
                                @endif
                            </tr>
                         @endforeach
