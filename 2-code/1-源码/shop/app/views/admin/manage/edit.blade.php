            ...
            <div class="table-content m-t-30">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <input class="form-control"  datatype="s3-20" disabled="disabled" ignore="ignore" errormsg="用户名在3~20位之间"
                                       tipsrmsg="请输入3-20位字母字符" name="account" type="text" value="{{$user->account}}">
                ...
                <div class="simple-form-field">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <input class="form-control"  datatype="e" errormsg="邮箱格式不正确" tipsrmsg="请输入邮箱地址"
                ...
                <div class="simple-form-field">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <input class="form-control"  datatype="*"  tipsrmsg="请输入用户姓名" type="text"
