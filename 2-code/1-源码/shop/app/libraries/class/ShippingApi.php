...
class  ShippingApi {
    ...
    //订阅url
    private  $DingyueURL  =  'http://testapi.kdniao.cc:8081/api/dist';
     ...
     * 数据订阅
     */
    function orderTracesSubByJson($Orderinfo){
        $requestData="{'OrderCode': '".$Orderinfo['order_sn']."',".
            "'ShipperCode':'".$Orderinfo['shiptype']."',".
            "'LogisticCode':'".$Orderinfo['shipno']."',".
            "'ExpType':1,".  //快递类型 标准邮件
            "'IsNotice':0}";
        $datas = array(
            'EBusinessID' =>  $this->EBusinessID,
        ...
        $datas['DataSign'] = $this->encrypt($requestData, $this->AppKey);
        $result=$this->sendPost($this->DingyueURL, $datas);
