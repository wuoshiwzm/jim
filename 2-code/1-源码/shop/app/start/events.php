 ...
 * 商品状态改变
 */
Event::listen('product.changeStatus', function ($entityId) {
    //删除收藏
    Source_User_UserInfoCollect::where('entity_id', $entityId)->delete();
    //删除购物车
    Source_Cart_CartItem::where('product_id', $entityId)->delete();
});
