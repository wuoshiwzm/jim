...
$router->any('/orderitem/remove/{row_id}', 'OrderMemberController@removeItem');
...
$router->any('/refund/sendhuo/{id?}', 'RefundMemberController@sendhuo');
$router->any('/refund/saveship', 'RefundMemberController@saveshop');
...
$router->any('/user/header', 'ConfigMemberController@UploadHeader');
