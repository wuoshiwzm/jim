                ...
                <form class="form-horizontal form" accept-charset="UTF-8"  method="post" action="{{url('admin/product/goods')}}">
                            ...
                            <div class="col-sm-9">
                                <div class="form-control-box">
                                    <select class="form-control valid w200" name="type" >
                                        ...
                                        <option value="2">可配置产品</option>
                                        <option value="3">虚拟产品</option>
                                        <option value="4">可下载产品</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="simple-form-field">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="form-control-box">
                                    <input type="text" class="form-control" name="jingjie" datatype="stock" onblur="checkjingjie()" maxlength="5" errormsg="警戒库存为1-5位正整数" tipsrmsg="请输入1-5位正整数" >
                    ...
                    @include('admin.product.freight',array('freight'=>$freight))
