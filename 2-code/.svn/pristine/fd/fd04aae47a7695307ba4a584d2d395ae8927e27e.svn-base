            ...
            <div class="table-content m-t-30">
                ...
                <div class="simple-form-field" style=" border:1px silver;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <input type="text" class="form-control"  ignore="ignore"    name="core[kefu_phone]" value="{{getConfig('core','kefu_phone')}}" >
                                <span class="Validform_checktip"></span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">
                            <span class="text-danger ng-binding">*</span>
                            <span class="ng-binding">通知方式：</span>
                        </label>
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <select class="form-control valid w180"  name="core[tongzhi_type]">
                                    <option value="" >请选择客户通知方式</option>
