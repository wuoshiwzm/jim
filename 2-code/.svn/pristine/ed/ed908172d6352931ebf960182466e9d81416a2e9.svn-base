...
<div class="ge_admin01">
    <div class="ge_admin_xin">
        ...
        <ul>
            <li class="nav_on01 @if(!(exiturl('config/index') || exiturl('notice'))) nav_on @endif ""><a href="{{url('member')}}">个人中心</a></li>
            <li class="nav_on02 @if(exiturl('config/index')) nav_on @endif "><a href="{{url('member/config/index')}}">账号设置</a></li>
            <li class="nav_on03 @if(exiturl('notice')) nav_on @endif "><a href="{{url('member/config/notice')}}">消息
                    <span>
                      {{ $userinfo->userlog->count()}}
                    </span></a></li>
        </ul>
