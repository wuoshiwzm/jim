@section('title','用户登录')
@section('css')
    <link type="text/css" rel="stylesheet" href="{{asset('css/frontend/iconfont.css')}}">
                        ...
                        <form class="layui-form m-form form" action="{{url('member/login_verify')}}" method="post">
                            ...
                            <div class="layui-form-item">
                                <div class="layui-input-block input_po">
                                    ...
                                    <input type="text" name="name" placeholder="请输入用户名/注册手机号码" autocomplete="off"
                                           ...
                                           datatype="*" errormsg="请输入用户名" tipsrmsg="请输入用户名"
                            ...
                            <div class="layui-form-item ">
                                <div class="layui-input-block input_po">
                                    ...
                                    <input type="password" name="password" placeholder="密 码" autocomplete="off"
                                           ...
                                           errormsg="请输入密码" tipsrmsg="请输入密码" nullmsg="请输入密码">
                            ...
                            <div class="layui-form-item">
                                <div class="layui-input-block">
                                    <input type="submit" class="layui-btn w40b font_deng font_deng_btn" value="登 录"/>
                                </div>
                            </div>
                        </form>
