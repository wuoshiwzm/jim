...
//生成分类对应的检索数据
Route::post('/generate/screen', 'CategoryController@generateScreen');
//品牌管理
...
Route::post('/product/goods/freight', 'ProductController@freight');
//添加产品图片页面
...
//图片上传模板调用 多图
Route::get('/get/multi_imgtemplet/{index}', 'PublicController@getMultiImgTemplet');
