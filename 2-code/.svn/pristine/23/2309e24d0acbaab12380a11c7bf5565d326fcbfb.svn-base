                ...
                <div class="simple-form-field">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" class="form-control w100" name="beg_time"  id="beg_time" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'end_time\')||\'2120-10-01\'}'})"  value="{{$set['beg_time']}}">
                            至 <input type="text" class="form-control w100" name="end_time" id="end_time" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'beg_time\')||\'2120-10-01\'}'})" value="{{$set['end_time']}}">
                        </div>
                    </div>
                </div>
