...
@section('content')
    <div class="page">
        ...
        <!--表单-->
        <form id="SystemConfigModel" class="form-horizontal form"  action="{{url('admin/product/attribute_edit')}}" method="post">
            <input type="hidden"  name="id" value="{{encode($data->id)}}">
            <input type="hidden"  name="is_system" value="{{$data->is_system}}">
            <div class="table-content m-t-30 ">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <input type="text"  name="name" readonly="readonly"  value="{{$data->name}}" class="form-control valid"  datatype="/^[a-z_]{3,20}$/" ajaxurl="/admin/getonlyinfo?type=attrbute&id={{$data->id}}" tipsrmsg="请输入3-20位英文字母" errormsg="3-20位英文字母">
                ...
                <div class="simple-form-field">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <input type="text"  name="admin_label" value="{{$data->admin_label}}" class="form-control valid" datatype="s2-20" tipsrmsg="请输入2-20位字符（不包含特殊字符）" errormsg="2-20位字符（不包含特殊字符）">
                                <span class="Validform_checktip"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="simple-form-field">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <input type="text"  name="length" value="{{$data->length}}" class="form-control valid" datatype="varcherlength" ajaxurl="/admin/getonlyinfo?type=attrbuteLength&id={{$data->id}}"  maxlength="3" tipsrmsg="请输入1-255之间的正整数" errormsg="请输入1-255之间的正整数">
                                <span class="Validform_checktip"></span>
                            </div>
                            <div class="help-block help-block-t">注意：一个汉字为3个字节，长度确定后修改时候不能小于本次设置的长度</div>
                        </div>
                    </div>
                </div>
                <div class="simple-form-field">
                ...
                <div class="simple-form-field">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <input type="text"  name="front_lable" value="{{$data->front_lable}}" class="form-control valid" datatype="s2-20" tipsrmsg="请输入2-20位字符（不包含特殊字符）" errormsg="2-20位字符（不包含特殊字符）">
                                <span class="Validform_checktip"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="simple-form-field">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <input type="text"  name="sort" ignore="ignore" value="{{$data->sort}}" class="form-control valid" datatype="n1-3" tipsrmsg="请输入1-3位数字" errormsg="请输入1-3位数字">
                                <span class="Validform_checktip"></span>
                            </div>
                ...
                <div class="simple-form-field">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <div>
                                    <label class="control-label cur-p m-r-10"><input type="radio" name="is_hidden" value="1" @if( $data->is_hidden == 1) checked="checked"@endif>隐藏</label>
                                    <label class="control-label cur-p m-r-10"><input type="radio" name="is_hidden" value="0" @if( $data->is_hidden == 0) checked="checked"@endif>显示</label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="simple-form-field">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <div>
                                    <label class="control-label cur-p m-r-10"><input type="radio" name="is_layer_search" value="1" @if( $data->is_layer_search == 1) checked="checked" @endif >是</label>
                                    <label class="control-label cur-p m-r-10"><input type="radio" name="is_layer_search" value="0" @if( $data->is_layer_search == 0) checked="checked" @endif >否</label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="simple-form-field">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <div>
                                    <label class="control-label cur-p m-r-10"><input type="radio" name="is_html_allowed_on_front" value="1" @if( $data->is_html_allowed_on_front == 1) checked="checked" @endif >是</label>
                                    <label class="control-label cur-p m-r-10"><input type="radio" name="is_html_allowed_on_front" value="0" @if( $data->is_html_allowed_on_front == 0) checked="checked" @endif>否</label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <select class="form-control valid w200" name="valid_rule">
                                    ...
                                    <option value="s" @if($data->valid_rule == 's') selected="selected" @endif>字符串类型</option>
                                    <option value="*" @if($data->valid_rule == '*') selected="selected" @endif>检测是否有输入，可以输入任何字符，不留空即可通过验证</option>
                                    <option value="*2-30" @if($data->valid_rule == '*2-30') selected="selected" @endif>2-30个字符串</option>
                                    ...
                                    <option value="url" @if($data->valid_rule == 'url') selected="selected" @endif>网址</option>
                                    <option value="je" @if($data->valid_rule == 'je') selected="selected" @endif>价格</option>
                                    <option value="weight" @if($data->valid_rule == 'weight') selected="selected" @endif>重量</option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="simple-form-field">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <input type="text" name="tipgs" value="{{$data->tipgs}}"  class="form-control valid" datatype="s3-20" tipsrmsg="请输入3-20位字符（不包含特殊字符）" errormsg="3-20位字符（不包含特殊字符）">
                                <span class="Validform_checktip"></span>
                            </div>
                ...
                <div class="simple-form-field">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <input type="text" name="errormsg" value="{{$data->errormsg}}" class="form-control valid" datatype="s3-20" tipsrmsg="请输入3-20位字符（不包含特殊字符）" errormsg="3-20位字符（不包含特殊字符）">
                                <span class="Validform_checktip"></span>
                            </div>
