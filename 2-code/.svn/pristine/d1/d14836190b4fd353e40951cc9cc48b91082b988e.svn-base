            ...
            <div class="table-content m-t-30">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <input class="form-control"
                                       ajaxurl="{{url("/admin/manage/validator")}}"
                                       datatype="s3-20" errormsg="用户名在3~20位之间" tipsrmsg="请输入3-20位字母字符" name="account" type="text">
                ...
                <div class="simple-form-field">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <input class="form-control"  datatype="e" errormsg="邮箱格式不正确" tipsrmsg="请输入邮箱地址" type="text" name="email">
                                <span class="Validform_checktip"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="simple-form-field">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <input class="form-control"  datatype="*"  tipsrmsg="请输入用户姓名" type="text" name="fullname">
                                <span class="Validform_checktip"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="simple-form-field">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <input class="form-control"  datatype="*6-15" errormsg="密码范围在6~15位之间！"
                                       tipsrmsg="请输入6-15位密码" name="password" type="password">
                                <span class="Validform_checktip"></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="simple-form-field">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <input class="form-control"  datatype="*"
                                       recheck="password" errormsg="您两次输入的密码不一致！"
                                       tipsrmsg="请输入确认密码" name="confirm" type="password">
                                <span class="Validform_checktip"></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-8">
                            <div class="form-control-box">
                                <div>
                                    ...
                                    <input  name="status" datatype="*" errormsg="请选择是否启用" value="1" type="radio">
