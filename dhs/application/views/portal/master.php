                ...
                <div class="btn-toolbar pull-right notification-nav">
                    ...
                    <div class="btn-group">
                        <div class="dropdown">
                            ...
                            <a class="btn btn-notification" href='/member/login/logout'><i
                    ...
                    <ul class="accordion-nav">
                        <?php if (in_array($userObj->user_role, array("admin", "noc"))) { ?>
                            ...
                            <li><a href="/portal/substation_list/<?php echo $userObj->city_code; ?>"><i
                                            class="icon-share"></i><?php echo Defines::$gCity[$userObj->city_code]; ?>
                                </a></li>
                        <?php } ?>
                    </ul>
                </div>
                <div id="performance" class="tab-pane">
                    ...
                    <ul class="metro-sidenav clearfix">
                        ...
                        <li><a class="bondi-blue" href="/portal/powermeter_ec_link_relative_ratio"><i
                                        class="icon-key"></i><span>能耗同、环比查询</span></a></li>
                    ...
                    <div id="door" class="tab-pane">
                        ...
                        <ul class="metro-sidenav clearfix">
                            <?php if (User::IsUserHasPermission($userObj->id, "门禁权限管理") || in_array($userObj->user_role, array('operator', 'city_admin', 'admin'))) { ?>
                                <li><a
                                            class="bondi-blue" href="/portal/door_manage"><i
                                                class="icon-lock"></i><span>门禁权限管理</span>
                                    </a></li>
                            <?php } ?>
