					...
					<div class="widget-head bondi-blue">
                      ...
                      <ul class="dowebok">
                                ...
                                <li class="dowebok1">                                 
								 ...
								 <a rel="group" class="video" href="#<?php echo $substationObjs->stationImage?>" >video link</a>
								 <?php }else{?>				
								 <a rel="group"  class="image" href="/public/portal/Station_image/<?php echo $substationObjs->stationImage?>" >文本								
								 </a>
								 <?php }?>
					   ...
					   <table
							...
							<?php $i = $offset + 1;foreach ($substationList as $substationObj){?>  
							 <tr>
									...
									<li class="dowebok1">	
									<?php if(substr(strrchr($imgObj, '.'), 0)==".flv")	{?>
									<a rel="group" class="video" href="#<?php echo $imgObj?>" >Vedio Link</a>
									<?php }else{?>				
									<a rel="group" class="image" href="/public/portal/Station_image/<?php echo $imgObj?>" >								
									<img src="/portal/station_thumb/<?php echo $imgObj?>" alt="" /></a>
									<?php }?>
									</li>
									<?php }?>
									</ul>
