        ...
        <div class="table-content m-t-30">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text"  class="form-control valid"  name="m_name" ajaxurl="/admin/getonlyinfo?type=shop" datatype="s3-20" tipsrmsg="请输入3-20个字符（不能包含特殊符号）" errormsg="请输入3-20个字符（不能包含特殊符号）" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box addimg">
                            <a href="javascript:;"><img onclick="getImgTemplet( this,'ico' )"  src="/images/admin/addimg.png" width="100" height="100"></a>
            ...
            <div class="simple-form-field">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-box">
                            <input type="text"  class="form-control valid" name="phone" ignore="ignore" datatype="tel" tipsrmsg="请输入手机号码或者固定电话" errormsg="电话格式有误" >
                            <span class="Validform_checktip "></span>
                        </div>
                    </div>
                </div>
