 ...
 */
    ...
    {
        return $this->belongsTo("Source_Product_ProductEntityStock","product_id","entity_id");
    }
    ...
    {
        return $this->hasMany('Source_Order_OrderShippingDetail','item_id');
    }

    public function mendian()
    {
        return $this->belongsTo('Source_User_ShopInfo','shop_id','id');
    }
