    ...
    <div class="page">
                ...
                <div class="simple-form-field">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" class="form-control w100" id="beg_time"  name="beg_time" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'end_time\')||\'2120-10-01\'}'})" value="{{$set['beg_time']}}">
                            至
                            <input type="text" class="form-control w100" id="end_time"  name="end_time" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'beg_time\')||\'2120-10-01\'}'})" value="{{$set['end_time']}}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <select  class="form-control"  name="status">
                                ...
                                <option value="7" @if( $set['status']  ==7) selected="selected"  @endif>完成订单</option>
                            </select>
                        </div>
                    </div>
                </div>
        ...
        <div class="common-title">
            <div class="ftitle">
                ...
                <h5>
                    (&nbsp;共
                    <span data-total-record="true">{{$list->getTotal()}}</span>
                    条记录&nbsp;)
                </h5>
            </div>
            <div class="operate">
                <a class="reload" href="javascript:location.reload();" data-toggle="tooltip" data-placement="auto bottom" title="" data-original-title="刷新数据">
                    <i class="iconfont">&#xe6fb;</i>
                </a>
            </div>
        </div>
        ...
        <div class="table-responsive">
            <table id="table_list" class="table table-hover">
                ...
                <tr>
                    ...
                    <th class="w100" style="cursor: pointer;">是否退款</th>
                ...
                @if(count($list))
                    @foreach( $list as $val)
                        <tr>
                            ...
                            <td>{{$val->refund->count()?"退款退货":'未退款'}}</td>
