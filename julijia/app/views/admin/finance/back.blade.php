...
@section("content")
    <div class="page">
        ...
        <!--搜索-->
        <div class="search-term m-b-10"><form action="{{url("/admin/frefund/back")}}" method="get">
                ...
                @foreach($data as $row)
                    <tr>
                        ...
                        <td>
                            ...
                            @elseif ($row->status == 3)
                                <font class="c-999">平台已审核，买家未发货</font>
                            @elseif ($row->status == 4)
                                <font class="c-999">平台已审核，买家已发货</font>
                            @elseif ($row->status == 5)
                                <font class="c-999">平台已审核，平台已经收货</font>
                            @elseif ($row->status == 6)
                        ...
                        <td class="handle">
                            ...
                            @if($row->status == 5)
                                <a href="javascript:void(0);" class="t_ok"  onclick="tuikuan('{{encode($row->id)}}')" data-refund={{encode($row->id)}}>确认退款</a>
                            @endif()
                        </td>
                    </tr>
                @endforeach
...
@section("footer_js")
    ...
    <script type="text/javascript" src="{{url('js/admin/finance/refund.js')}}?v=0302"></script>
