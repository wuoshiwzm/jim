                            ...
                            <td class="item">
                                <div class="pic-info">
                                    <a href="/{{$goods_item->product_id}}.html" class="goods-thumb" title="{{$goods_item->product_name}}" target="_blank">
                                        <img src="{{ getImgSize( 'goods', $goods_item->product_id, isset($goods_item->product->small_image)?$goods_item->product->small_image:'' ) }}" alt="查看商品详情">
                                    </a>
                                </div>
                                <div class="txt-info">
                                    <div class="desc span02">
                                        <a href="/{{$goods_item->product_id}}.html" class="goods-name" target="_blank" title="{{$goods_item->product_name}}">{{$goods_item->product_name}}</a>
                                    </div>
                                </div>
                            </td>
                            <!--单价-->
