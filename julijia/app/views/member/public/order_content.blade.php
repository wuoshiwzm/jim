            ...
            <table cellpadding="0" cellspacing="0" class="order_tab">
                <tr>
                    <td colspan="7" class="order_ding">
                        ...
                        <span>支付金额：{{$order->pay_amount}}</span>
                    ...
                    <tr>
                        <td>
                            <dl>
                                <dt>
                                        ...
                                        <a href="{{url($item->product_id.'.html')}}" target="_blank">
                                ...
                                <dd class="img_dd">
                                    <a href="{{url($item->product_id.'.html')}}" target="_blank"> {{$item->product_name}}</a>
                                </dd>
                                @if(!empty($item->guige))
                        ...
                        <td width="16%" class="operation">
                            ...
                            @if($order->pay_status == 3 && $item->shipping_status!=3)
                                ...
                                @elseif(!$item->refund()->count()&& $item->shipping_status ==1)
                        ...
                        @if($k === 0)
                            <td width="14%" class="operation" rowspan="{{$order->item->count()}}">
                                ...
                                @if($order->pay_status == 1 || $order->pay_status == 2)
                                    <a href="/member/order/pay?order_id={{encode($order->id)}}"
                                       class="margin_top">去付款</a>
                                @endif
                            </td>
