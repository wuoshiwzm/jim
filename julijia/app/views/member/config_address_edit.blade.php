                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select name="province" id="address" lay-filter="province">
                            @if(isset($addrEdit->provinceInfo->provinceID))
                                <option value="{{$addrEdit->provinceInfo->provinceID}}" selected="selected">{{$addrEdit->provinceInfo->province}}</option>
                            @else
                    ...
                    <div class="layui-input-inline">
                        <select name="city" id="address1" lay-filter="city">
                            @if(isset($addrEdit->cityInfo->cityID))
                                <option value="{{$addrEdit->cityInfo->cityID}}" selected="selected">{{$addrEdit->cityInfo->city}}</option>
                            @else
                    ...
                    <div class="layui-input-inline">
                        <select name="area" id="address2" lay-filter="area">
                            @if(isset($addrEdit->areaInfo->areaID))
                                <option value="{{$addrEdit->areaInfo->areaID}}" selected="selected">{{$addrEdit->areaInfo->area}}</option>
                            @else
                ...
                <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    @foreach($addrs as $addr)
                        <tr>
                            <td>{{$addr->name}}</td>
                            <td>
                                @if(isset($addr->provinceInfo->province)){{$addr->provinceInfo->province}}@endif,
                                @if(isset($addr->cityInfo->city)){{$addr->cityInfo->city}}@endif,
                                @if(isset($addr->areaInfo->area)){{$addr->areaInfo->area}}@endif
                            </td>
                            <td>{{$addr->address}}</td>
                            <td>{{$addr->zipcode}}</td>
                            <td>{{$addr->phone}}</td>
