			...
			<div class='span12'>
				<div class="tab-widget">
					<ul class="nav nav-tabs">
                	   ...
                	   <li class="active"><a href="/portal/alarm_rank"><i class="icon-tasks"></i>告警排名报表</a></li>
...
<!-- 										<option value='all'>所有状态</option> -->
				            ...
				            <div class="control-group">
								...
								<label class="control-label" style="float: left;">月度告警次数前十位</label>
								<div class="controls" style="margin-left: 20px; float: left;">
										<label style="float:left;width:100px;"><input type="radio" name="ecType"  <?php if($ecType == '0'||$ecType == null){?> checked="checked"  <?php }?> value="0" />&nbsp;&nbsp;&nbsp;&nbsp;局站</label>
									    <label style="float:left;width:100px;"><input type="radio" name="ecType"  <?php if($ecType == '1'){?> checked="checked"  <?php }?> value="1" />&nbsp;&nbsp;&nbsp;&nbsp;设备</label>		
								</div>
							</div>
				...
				<div class="content-widgets light-gray">
					...
					<div class="widget-container">
						...
						<?php if($ecType == '0'){?>
							...
							<tbody id="tbAlarm">
							<?php $i = $offset + 1; foreach ($alarmRankList as $alarmRankObj){?>
							<tr>
						        </td>
								<td><?php echo $i++;?></td>
								<td><?php echo htmlentities($alarmRankObj->subname,ENT_COMPAT,"UTF-8");?></td>
								<td><?php echo htmlentities($alarmRankObj->subAlarmCount,ENT_COMPAT,"UTF-8");?></td>
								</tr>
							<?php }?>
							</tbody>
						<?php }?>
						<?php if($ecType == '1'){?>
							...
							<tr>
								...
								<td><?php echo $i++;?></td>
								<td><?php echo htmlentities($alarmRankObj->subname,ENT_COMPAT,"UTF-8");?></td>
								<td><?php echo htmlentities($alarmRankObj->roomname,ENT_COMPAT,"UTF-8");?></td>
								<td><?php echo htmlentities($alarmRankObj->devname,ENT_COMPAT,"UTF-8");?></td>
								<td><?php echo htmlentities($alarmRankObj->devAlarmCount,ENT_COMPAT,"UTF-8");?></td>
								</tr>
							<?php }?>
							</tbody>
						<?php }?>		
