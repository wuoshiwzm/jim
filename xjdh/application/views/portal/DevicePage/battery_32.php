				...
				<?php }?>
                   ...
                   <tr >		
					...
					<tr>		
						<td>1</td>
						<td bat_num='0'><span></span>&nbsp;</td>
						<td class="hasThreshold"><?php if(in_array($userObj->user_role, array("admin","city_admin"))){ ?><button data_id='<?php echo $dataObj->data_id;?>' field="battery_0_value" model='<?php echo $dataObj->model;?>' class="btn btn-warning setThreshold">设置阀值</button><?php } ?></td>
						<td>2</td>
						<td bat_num='1'><span></span>&nbsp;</td>
						<td class="hasThreshold"><?php if(in_array($userObj->user_role, array("admin","city_admin"))){ ?><button data_id='<?php echo $dataObj->data_id;?>' field="battery_1_value" model='<?php echo $dataObj->model;?>' class="btn btn-warning setThreshold">设置阀值</button><?php } ?></td>
						<td>3</td>
						<td bat_num='2'><span></span>&nbsp;</td>
						<td class="hasThreshold"><?php if(in_array($userObj->user_role, array("admin","city_admin"))){ ?><button data_id='<?php echo $dataObj->data_id;?>' field="battery_2_value" model='<?php echo $dataObj->model;?>' class="btn btn-warning setThreshold">设置阀值</button><?php } ?></td>
						<td>4</td>
						<td bat_num='3'><span></span>&nbsp;</td>
						<td class="hasThreshold"><?php if(in_array($userObj->user_role, array("admin","city_admin"))){ ?><button data_id='<?php echo $dataObj->data_id;?>' field="battery_3_value"  model='<?php echo $dataObj->model;?>' class="btn btn-warning setThreshold">设置阀值</button><?php } ?></td>
					</tr>
					<tr>		
						<td>21</td>
						<td bat_num='20'><span></span>&nbsp;</td>
						<td class="hasThreshold"><?php if(in_array($userObj->user_role, array("admin","city_admin"))){ ?><button data_id='<?php echo $dataObj->data_id;?>' field="battery_20_value" model='<?php echo $dataObj->model;?>' class="btn btn-warning setThreshold">设置阀值</button><?php } ?></td>
						<td>22</td>
						<td bat_num='21'><span></span>&nbsp;</td>
						<td class="hasThreshold"><?php if(in_array($userObj->user_role, array("admin","city_admin"))){ ?><button data_id='<?php echo $dataObj->data_id;?>' field="battery_21_value" model='<?php echo $dataObj->model;?>'  class="btn btn-warning setThreshold">设置阀值</button><?php } ?></td>
						<td>23</td>
						<td bat_num='22'><span></span>&nbsp;</td>
						<td class="hasThreshold"><?php if(in_array($userObj->user_role, array("admin","city_admin"))){ ?><button data_id='<?php echo $dataObj->data_id;?>' field="battery_22_value" model='<?php echo $dataObj->model;?>'  class="btn btn-warning setThreshold">设置阀值</button><?php } ?></td>
						<td>24</td>
						<td bat_num='23'><span></span>&nbsp;</td>
						<td class="hasThreshold"><?php if(in_array($userObj->user_role, array("admin","city_admin"))){ ?><button data_id='<?php echo $dataObj->data_id;?>' field="battery_23_value" model='<?php echo $dataObj->model;?>'  class="btn btn-warning setThreshold">设置阀值</button><?php } ?></td>
					</tr>                  
			            </tbody>
					</table>
                                    <?php }?>	
    ...
    for ($j = 0; $j < $row; $j += 4) {
        ?>       
                  <tr>  <?php if($j+1<=$row){ ?>	
						...
						<?php if(in_array($userObj->user_role, array("admin","city_admin"))){ ?>
						<button
								data_id='<?php echo $dataObj->data_id;?>' model='<?php echo $dataObj->model;?>' 
