...
<div class='row-fluid'>
    <div class='rt-data' data_type='liebert-pex'
        ...
        <ul>
            ...
            <li><h5>
                    更新时间：<span class="update_datetime"
                               style='font-size: 20px;'><?php echo date('Y-m-d H:i:s'); ?></span>
                </h5></li>
        </ul>
        <?php } else { ?>
            <div class="row-fluid ">
                ...
                <div class="span3">
                    <div class="board-widgets blue small-widget">
                        <div class="board-widgets-content">
                            <span class="n-counter update_datetime"
                                  style='font-size: 20px;'><?php echo date('Y-m-d H:i:s'); ?></span><span
                ...
                <?php if ($_SESSION['XJTELEDH_USERROLE'] == 'admin') { ?>
                    <p>
                        ...
                        <button class='btn btn-info dev-info'
                                data_id='<?php echo $liebertPexObj->data_id; ?>'
                                model='<?php echo $liebertPexObj->model; ?>'>详细信息
                        </button>
                    </p>
                <?php } ?>
            </div>
        ...
        <table
            ...
            <tbody>
            <?php foreach (Defines::$gLiebertPexRemoteMesureParams as $key => $val) { ?>
                <tr>
                    ...
                    <?php if ((!isset($isMobile) || !$isMobile) && $_SESSION['XJTELEDH_USERROLE'] == 'admin') { ?>
                        <td class="hasThreshold">
                            <button
                                    ...
                                    class="btn btn-warning setThreshold">设置告警规则
                            </button>
                        </td>
                    <?php } ?>
                </tr>
        ...
        <table
            ...
            $index = 1;
            foreach (Defines::$gLiebertPexRemoteSignalParams as $key => $val) {
                ?>
                <tr
                        id='liebert-pex-<?php echo $liebertPexObj->data_id . '-field' . $key; ?>'>
