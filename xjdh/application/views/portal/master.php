            ...
            <div class="left-secondary-nav tab-content">
                <div id="rt_data" class="tab-pane">
                    ...
                    <ul class="accordion-nav">
                        ...
                        <li><a href="/portal/substation_list/<?php echo $city_code; ?>"><i
                                        class="icon-share"></i><?php echo $city_name; ?></a></li>
                        <?php }
                        }else if (!empty($userObj->city_code)){ ?>
                        <li><a href="/portal/substation_list/<?php echo $userObj->city_code; ?>"><i
                                        class="icon-share"></i><?php echo Defines::$gCity[$userObj->city_code]; ?></a>
                        </li>
                        <?php } ?>
                    </ul>
                </div>
                <div id="performance" class="tab-pane">
                    ...
                    <ul class="metro-sidenav clearfix">
                        <li><a class="bondi-blue" href="/portal/acquisition_anomaly"><i class="icon-key"></i><span>采集异常分析</span></a>
                        </li>
                        <li><a class="bondi-blue" href="/portal/powermeter_history"><i class="icon-key"></i><span>电表历史数据查询</span></a>
                        </li>
                        <li><a class="bondi-blue" href="/portal/powermeter_ec_history"><i class="icon-key"></i><span>能耗历史数据查询</span></a>
                        </li>
                        <li><a class="bondi-blue" href="/portal/powermeter_ec_struct"><i class="icon-key"></i><span>能耗结构图查询</span></a>
                        </li>
                        <li><a class="bondi-blue" href="/portal/powermeter_ec_year_basis"><i class="icon-key"></i><span>能耗同比（趋势）查询</span></a>
                        </li>
                        <li><a class="bondi-blue" href="/portal/powermeter_ec_link_relative_ratio"><i
                                        class="icon-key"></i><span>能耗环比（趋势）查询</span></a></li>
                        <li><a class="bondi-blue" href="/portal/powermeter_ec_compare"><i class="icon-key"></i><span>能耗对比分析查询</span></a>
                        </li>
                        <li><a
                                    class="bondi-blue" href="/portal/fluctuation"><i
                                        class="icon-key"></i><span>负载波动率</span>
                            </a></li>
                        <!-- <li><a
                ...
                <div id="alarm" class="tab-pane">
                    ...
                    <ul class="metro-sidenav clearfix">
                        ...
                        <li><span class="notify-tip" id='notify-alert-all'>0</span> <a
                                    class="bondi-blue" href="/portal/alarm"><i
                                        class="icon-bell-alt"></i><span>所有告警</span>
                            </a></li>
                ...
                <div id="signals" class="tab-pane">
                    ...
                    <ul class="metro-sidenav clearfix">
                        <li>
                            <a class="bondi-blue"
                               href="<?php echo site_url("signals/deviceSignals"); ?>">
                                <i class="icon-comments"></i><span>设备信号设置</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a class="bondi-blue"
                               href="<?php echo site_url("signals/alertSignals"); ?>">
                                <i class="icon-bell"></i><span>告警信号设置</span>
                            </a>
                        </li>
