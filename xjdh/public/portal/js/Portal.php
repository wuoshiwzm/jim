...
//     	 $accessid=(int)$currents->accessid;
    ...
    function loginlogUser()
    {
        ...
        if($export == "exporttoexcel")
        {
        	...
        	$logList = User::Get_UserLoginList($txtName,$userRole,$userAgent,$selCity,$selCounty,$selSubstation,$datestart,$dateend);
...
//   		header('Content-type: application/json');
   	...
   	function acquisition_anomaly()
   	{
        ...
        $data['dateRange'] = $dateRange = $this->input->get('dateRange');
   		...
   		{
   			$this->load->library("mongo_db");
  			$data['count'] = $count = $this->mp_xjdh->Get_Power302a_Count($dataIdArr,$dateRangeArr[0],$dateRangeArr[1]);
  			$data['powerDataList'] = $powerDataList = $this->mp_xjdh->Get_Power302a_List($dataIdArr,$dateRangeArr[0],$dateRangeArr[1],$offset,DEFAULT_PAGE_SIZE);
